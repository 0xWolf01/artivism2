export const artPieces = {
  gioconda: {
    ...
    concept: "Capitalism",
    description: "Pumpkin soup on oil on poplar panel, hurled with a decisive gesture against Leonardo da Vinci's Mona Lisa. The liquid strikes and slides toward the lower frame, tracing an orange veil. A performance executed by two members of Riposte Alimentaire and witnessed by dozens. The act reframes the painting as a silent witness to an agricultural system in crisis. Carried out with precision and accompanied by the shouted question: \"Art, or the right to healthy and sustainable food?\" Covered by international press including Le Monde, The Guardian, Vanity Fair, AP News, and circulated widely across social media.",
    mainImage: "/assets/img/gioconda-1920.jpg",
    previewImage: "/assets/img/pumkin-soup.webp",
  ...
  lesmeules: {
    ...
    mainImage: "/assets/img/les-meules-1920.jpg",
  ...
  deathandlife: {
    ...
    previewImage: "/assets/img/petroleum.webp",
    previewText: "Weapon: Fossil fuel, Pegamento"
  },
  thesower: {
    ...
    previewImage: "/assets/img/pea-soup.webp",
  ...
  sunflowers: {
    ...
    previewText: "Weapon: Tomato soup, Pegamento"
  },
  giverny: {
    ...
    previewImage: "/assets/img/marker.webp",
  ...
  leprintemps: {
    ...
    mainImage: "/assets/img/leprintemps-1920.jpg",
    previewImage: "/assets/img/tomate-soup.webp",
  ...
  campbells: {
    ...
    mainImage: "/assets/img/cambells-protest.jpg",
    previewImage: "/assets/img/marker.webp",
    previewText: "Weapon: Blue marker"
  }
};
