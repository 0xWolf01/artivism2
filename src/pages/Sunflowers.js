...
const Sunflowers = () => {
  ...
  // Bloquear scroll vertical en Sunflowers
  useEffect(() => {
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1.2fr_0.8fr] gap-10 xl:gap-16 items-start xl:items-stretch">
        ...
        <div className="flex flex-col gap-6 mr-auto leading-relaxed xl:h-full xl:justify-between">
          <div className="flex flex-col gap-6">
            <h1 className="font-bold m-0 text-[1.5rem]">Tomato soup on Van Gogh's Sunflowers</h1>
            <div className="flex flex-col gap-0">
              <h2 className="font-bold m-0 text-[1rem]">National Gallery, London – October 14, 2022</h2>
              <p className="m-0 text-[0.85rem]">Capitalism</p>
            </div>
            <p className="text-[#555] text-[0.85rem] leading-snug m-0">
              A freeform launch of tomato soup onto Van Gogh's Sunflowers by two Just Stop Oil activists, accompanied by shouts of "Stop oil now!" and followed by physical adherence to the gallery wall.
            </p>
            <p className="text-[#555] text-[0.85rem] leading-snug m-0">
              Extensive artistic and media coverage, including The Guardian, BBC, CNN, and Le Monde within 24 hours. A pioneering icon of contemporary climate protest, and a clear influence on subsequent interventions across Europe.
            </p>
            <div className="flex flex-col gap-0">
              <p className="text-gray-500 text-[0.75rem] m-0 leading-tight">Medium</p>
              <p className="text-gray-500 text-[0.8rem] m-0 leading-tight">Tomato soup on canvas</p>
            </div>
            <div className="flex flex-col gap-0">
