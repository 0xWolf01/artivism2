...
const Lesmeules = () => {
  ...
  // Bloquear scroll vertical en Lesmeules
  useEffect(() => {
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1.2fr_0.8fr] gap-10 xl:gap-16 items-start xl:items-stretch">
        ...
        <div className="bg-[#f2f2f2] w-full h-auto p-4 md:p-6">
          ...
          >
            <img
              ...
              src="https://upload.wikimedia.org/wikipedia/commons/4/4e/Claude_Monet_-_Meules_%28W_1273%29.jpg"
              alt="Claude Monet - Les Meules (Grainstacks)"
            />
            {/* Hotspot */}
            <button
              type="button"
        ...
        <div className="flex flex-col gap-6 mr-auto leading-relaxed xl:h-full xl:justify-between">
          <div className="flex flex-col gap-6">
            <h1 className="font-bold m-0 text-[1.5rem]">Mashed potatoes on Monet's Les Meules</h1>
            <div className="flex flex-col gap-0">
              <h2 className="font-bold m-0 text-[1rem]">Museum Barberini, Potsdam – October 23, 2022</h2>
              <p className="m-0 text-[0.85rem]">Capitalism</p>
            </div>
            <p className="text-[#555] text-[0.85rem] leading-snug m-0">
              A controlled projection of mashed potatoes onto Claude Monet's Grainstacks by four activists from Letzte Generation. Executed with a two-handed forward throw at close range, targeting the centre of the canvas. The intervention recontextualises impressionist serenity within the urgency of collapsing ecosystems and fossil dependency.
            </p>
            <p className="text-[#555] text-[0.85rem] leading-snug m-0">
              Widely featured across German and international media, from Der Spiegel to The New York Times. Detention rate: 100%. Charges filed: 0%.
            </p>
            <div className="flex flex-col gap-0">
              <p className="text-gray-500 text-[0.75rem] m-0 leading-tight">Medium</p>
              <p className="text-gray-500 text-[0.8rem] m-0 leading-tight">Mashed potatoes on canvas</p>
            </div>
            <div className="flex flex-col gap-0">
