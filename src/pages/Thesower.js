...
const Thesower = () => {
  ...
  // Bloquear scroll vertical en Thesower
  useEffect(() => {
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1.2fr_0.8fr] gap-10 xl:gap-16 items-start xl:items-stretch">
        ...
        <div className="bg-[#f2f2f2] w-full h-auto p-4 md:p-6">
          ...
          >
            <img
              ...
              src="https://upload.wikimedia.org/wikipedia/commons/a/af/Vincent_van_Gogh_-_The_Sower_-_c._17-28_June_1888.jpg"
              alt="Vincent van Gogh - The Sower"
            />
            {/* Hotspot */}
            <button
              type="button"
        ...
        <div className="flex flex-col gap-6 mr-auto leading-relaxed xl:h-full xl:justify-between">
          <div className="flex flex-col gap-6">
            <h1 className="font-bold m-0 text-[1.5rem]">Pea soup on Van Gogh's The Sower</h1>
            <div className="flex flex-col gap-0">
              <h2 className="font-bold m-0 text-[1rem]">Palazzo Bonaparte, Rome – November 4, 2022</h2>
              <p className="m-0 text-[0.85rem]">Capitalism</p>
            </div>
            <p className="text-[#555] text-[0.85rem] leading-snug m-0">
              Pea soup, warm and opaque, projected with abrupt force onto the sower oil on canvas. The substance strikes the central figure from below, rising diagonally through the composition and dispersing across the upper field—cutting through sky, grain, and gesture.
            </p>
            <p className="text-[#555] text-[0.85rem] leading-snug m-0">
              Applied by two members of Ultima Generazione, the act merges alimentary matter with painterly tradition, contaminating pastoral rhythm with the weight of future famine. Broadcast widely across RAI, La Repubblica, and Il Messaggero.
            </p>
            <div className="flex flex-col gap-0">
              <p className="text-gray-500 text-[0.75rem] m-0 leading-tight">Medium</p>
              <p className="text-gray-500 text-[0.8rem] m-0 leading-tight">Pea soup on canvas</p>
            </div>
            <div className="flex flex-col gap-0">
