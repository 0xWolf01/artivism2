...
const LePrintemps = () => {
  ...
  // Bloquear scroll vertical en LePrintemps
  useEffect(() => {
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1.2fr_0.8fr] gap-10 xl:gap-16 items-start xl:items-stretch">
        ...
        <div className="bg-[#f2f2f2] w-full h-auto p-4 md:p-6">
          ...
          >
            <img
              ...
              src="https://upload.wikimedia.org/wikipedia/commons/c/c3/Monet_-_Le_Printemps%2C_1886.jpg"
              alt="Claude Monet - Le Printemps (Spring)"
            />
            {/* Hotspot */}
            <button
              type="button"
        ...
        <div className="flex flex-col gap-6 mr-auto leading-relaxed xl:h-full xl:justify-between">
          <div className="flex flex-col gap-6">
            <h1 className="font-bold m-0 text-[1.5rem]">Tomato soup on Claude Monet's Le Printemps</h1>
            <div className="flex flex-col gap-0">
              <h2 className="font-bold m-0 text-[1rem]">Musée des Beaux-Arts, Lyon – February 11, 2024</h2>
              <p className="m-0 text-[0.85rem]">Capitalism</p>
            </div>
            <p className="text-[#555] text-[0.85rem] leading-snug m-0">
              Concentrated tomato soup, forcefully applied onto Claude Monet's Spring, oil on canvas. A layer of food product delivered by two members of Riposte Alimentaire, replacing atmosphere with opacity.
            </p>
            <p className="text-[#555] text-[0.85rem] leading-snug m-0">
              The impact lands on the floral foreground, covering petals and grass beneath a soft orange film of ultra-processed matter, accompanied by the spoken caption: "What is more important—the art or the right to healthy food?" Covered by Le Monde, France Info, The Guardian, and international outlets.
            </p>
            <div className="flex flex-col gap-0">
              <p className="text-gray-500 text-[0.75rem] m-0 leading-tight">Medium</p>
              <p className="text-gray-500 text-[0.8rem] m-0 leading-tight">Tomato soup on oil on canvas</p>
            </div>
            <div className="flex flex-col gap-0">
